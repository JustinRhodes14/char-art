...
const products = [
  ...
  { id: 3,  name: 'Sleepy Fluffy Egg - Acrylic Pin',                    price: 6.50, inStock: true, shippingClass: 'package', materialType: 'pin' },
  ...
  { id: 6,  name: 'Seething Soft-Boiled Egg - Vinyl Sticker',           price: 1.50,  inStock: true, shippingClass: 'envelope' },
  { id: 7,  name: 'Cute Poached Egg - Acrylic Pin',                   price: 6.50,  inStock: true, shippingClass: 'package', materialType: 'pin' },
  { id: 8,  name: 'Sleepy Fluffy Egg - Vinyl Sticker',                    price: 1.50,  inStock: true, shippingClass: 'envelope' },
  { id: 9,  name: "I'm Baked Sticker Sheet",       price: 7.50, inStock: true, shippingClass: 'package', materialType: 'sticker-sheet' },
  { id: 10, name: 'Cute Poached Egg - Vinyl Sticker',                   price: 1.50,  inStock: true, shippingClass: 'envelope' },
  ...
  { id: 13, name: 'Strawberry Stacked Pancakes - Acrylic Pin',      price: 7.99,  inStock: true, shippingClass: 'package', materialType: 'pin-holographic' },
  { id: 14, name: 'The Deviled Eggs - Vinyl Sticker',              price: 1.50,  inStock: true, shippingClass: 'envelope' },
  { id: 15, name: 'Japanese Mayo Egg Toast - Acrylic Pin',            price: 6.50,  inStock: true, shippingClass: 'package', materialType: 'pin' },
